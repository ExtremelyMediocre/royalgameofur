...
var piece_scene := preload("res://Piece.tscn")  # Adjust if renamed
...
@onready var turn_label: Label = $"../UI/CanvasLayer/CurrentTurn"
...
func _ready() -> void:
	randomize()
	spawn_pieces(player1_node, "Player1", route1, preload("res://Player1Piece.png"))  # ✅ Make sure file exists
	spawn_pieces(player2_node, "Player2", route2, preload("res://Player2Piece.png"))  # ✅ Make sure file exists
	await game_loop()
